...
IMAGE_KING_W = f"{ROOT_PATH}icons/pieces/king_w.png"
IMAGE_KING_B = f"{ROOT_PATH}icons/pieces/king_b.png"
IMAGE_KING_W_LARGE = f"{ROOT_PATH}icons/pieces/king_w_large.png"
IMAGE_KING_B_LARGE = f"{ROOT_PATH}icons/pieces/king_b_large.png"
IMAGE_QUEEN_W = f"{ROOT_PATH}icons/pieces/queen_w.png"
IMAGE_QUEEN_B = f"{ROOT_PATH}icons/pieces/queen_b.png"
IMAGE_BISHOP_W = f"{ROOT_PATH}icons/pieces/bishop_w.png"
IMAGE_BISHOP_B = f"{ROOT_PATH}icons/pieces/bishop_b.png"
IMAGE_KNIGHT_W = f"{ROOT_PATH}icons/pieces/knight_w.png"
IMAGE_KNIGHT_B = f"{ROOT_PATH}icons/pieces/knight_b.png"
IMAGE_ROOK_W = f"{ROOT_PATH}icons/pieces/rook_w.png"
IMAGE_ROOK_B = f"{ROOT_PATH}icons/pieces/rook_b.png"
IMAGE_PAWN_W = f"{ROOT_PATH}icons/pieces/pawn_w.png"
IMAGE_PAWN_B = f"{ROOT_PATH}icons/pieces/pawn_b.png"
