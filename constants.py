...
IMAGE_K = f"{ROOT_PATH}icons/pieces/74x74/king_w.png"
IMAGE_k = f"{ROOT_PATH}icons/pieces/74x74/king_b.png"
IMAGE_Q = f"{ROOT_PATH}icons/pieces/74x74/queen_w.png"
IMAGE_q = f"{ROOT_PATH}icons/pieces/74x74/queen_b.png"
IMAGE_B = f"{ROOT_PATH}icons/pieces/74x74/bishop_w.png"
IMAGE_b = f"{ROOT_PATH}icons/pieces/74x74/bishop_b.png"
IMAGE_N = f"{ROOT_PATH}icons/pieces/74x74/knight_w.png"
IMAGE_n = f"{ROOT_PATH}icons/pieces/74x74/knight_b.png"
IMAGE_R = f"{ROOT_PATH}icons/pieces/74x74/rook_w.png"
IMAGE_r = f"{ROOT_PATH}icons/pieces/74x74/rook_b.png"
IMAGE_P = f"{ROOT_PATH}icons/pieces/74x74/pawn_w.png"
IMAGE_p = f"{ROOT_PATH}icons/pieces/74x74/pawn_b.png"
